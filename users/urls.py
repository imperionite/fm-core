...
urlpatterns = [
    ...
    path('auth/login/', LoginThrottleView.as_view(), name='rest_login'),  # override login URL
    ...
    path('auth/account-confirm-email/', VerifyEmailView.as_view(), name='account_confirm_email'),
    # djoser
    ...
    # custom
    path('deactivate/<username>/', UserDeactivateView.as_view(), name='users-retrieve-deactivate'),
]